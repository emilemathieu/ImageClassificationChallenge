...
X_multi = pd.read_csv('../data/kmeans/Xtr_features_kmeans.csv', header=None).as_matrix()
...
X_e = pd.read_csv('../data/kmeans/Xte_features_kmeans.csv', header=None).as_matrix()
...
#%%
prediction.to_csv('../data/evaluations/evaluation_kmeans.csv',#.format(datetime.datetime.now().strftime("%Y-%m-%d_%H:%M:%S")),
